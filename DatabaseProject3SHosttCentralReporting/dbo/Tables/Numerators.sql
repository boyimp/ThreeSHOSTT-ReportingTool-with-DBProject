CREATE TABLE [dbo].[Numerators] (
    ...
    [LastUpdateTime] ROWVERSION      NOT NULL,
    [Number]         INT             NOT NULL,
    [NumberFormat]   NVARCHAR (4000) NULL,
    [Name]           NVARCHAR (4000) NULL,
    CONSTRAINT [PK_dbo.Numerators] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
CREATE TRIGGER [dbo].[HONumerators]
   ON  [dbo].[Numerators]
