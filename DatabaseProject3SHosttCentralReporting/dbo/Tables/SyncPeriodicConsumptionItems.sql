CREATE TABLE [dbo].[SyncPeriodicConsumptionItems] (
    ...
    [StockIn]                                          DECIMAL (16, 4) CONSTRAINT [DF_SyncPeriodicConsumptionItems_StockIn] DEFAULT ((0)) NULL,
    [StockOut]                                         DECIMAL (16, 4) CONSTRAINT [DF_SyncPeriodicConsumptionItems_StockOut] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [PK_dbo_SyncPeriodicConsumptionItems] PRIMARY KEY CLUSTERED ([Id] ASC, [WarehouseConsumptionId] ASC, [PeriodicConsumptionId] ASC),
    CONSTRAINT [FK_dbo_SyncPeriodicConsumptionItems_dbo_SyncWarehouseConsumptions_PeriodicConsumptionId_WarehouseConsumptionId] FOREIGN KEY ([PeriodicConsumptionId], [WarehouseConsumptionId]) REFERENCES [dbo].[SyncWarehouseConsumptions] ([Id], [PeriodicConsumptionId]) ON DELETE CASCADE
);
