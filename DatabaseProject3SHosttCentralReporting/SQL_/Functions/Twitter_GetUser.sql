CREATE FUNCTION [SQL#].[Twitter_GetUser]
(@ConsumerKey NVARCHAR (100) NULL, @ConsumerSecret NVARCHAR (100) NULL, @AccessToken NVARCHAR (100) NULL, @AccessTokenSecret NVARCHAR (100) NULL, @UserID NVARCHAR (20) NULL)
RETURNS 
     TABLE (
        [UserID]                         BIGINT          NULL,
...
AS
 EXTERNAL NAME [SQL#.Twitterizer].[TWITTER].[GetUser]
