CREATE FUNCTION [SQL#].[Twitter_UnFollowUser]
(@ConsumerKey NVARCHAR (100) NULL, @ConsumerSecret NVARCHAR (100) NULL, @AccessToken NVARCHAR (100) NULL, @AccessTokenSecret NVARCHAR (100) NULL, @ScreenName NVARCHAR (20) NULL, @UserID BIGINT NULL)
RETURNS 
     TABLE (
        [UserID]                         BIGINT          NULL,
...
AS
 EXTERNAL NAME [SQL#.Twitterizer].[TWITTER].[UnFollowUser]
