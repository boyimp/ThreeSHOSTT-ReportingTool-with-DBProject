CREATE FUNCTION [SQL#].[Twitter_GetUserTimeline]
(@ConsumerKey NVARCHAR (100) NULL, @ConsumerSecret NVARCHAR (100) NULL, @AccessToken NVARCHAR (100) NULL, @AccessTokenSecret NVARCHAR (100) NULL, @OptionalParameters [SQL#].[Type_HashTable] NULL)
RETURNS 
     TABLE (
...
AS
 EXTERNAL NAME [SQL#.Twitterizer].[TWITTER].[GetUserTimeline]
