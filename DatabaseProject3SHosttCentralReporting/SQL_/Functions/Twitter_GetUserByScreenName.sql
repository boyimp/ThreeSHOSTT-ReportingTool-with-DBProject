CREATE FUNCTION [SQL#].[Twitter_GetUserByScreenName]
(@ConsumerKey NVARCHAR (100) NULL, @ConsumerSecret NVARCHAR (100) NULL, @AccessToken NVARCHAR (100) NULL, @AccessTokenSecret NVARCHAR (100) NULL, @ScreenName NVARCHAR (50) NULL)
RETURNS 
     TABLE (
        [UserID]                         BIGINT          NULL,
...
AS
 EXTERNAL NAME [SQL#.Twitterizer].[TWITTER].[GetUserByScreenName]
