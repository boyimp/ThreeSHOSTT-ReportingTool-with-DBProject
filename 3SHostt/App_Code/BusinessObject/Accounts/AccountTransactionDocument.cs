...
namespace ThreeS.Domain.Models.Accounts
{
    public class AccountTransactionDocument : EntityClass
    {
        ...
        private List<AccountTransaction> _accountTransactions;
        ...
        {
            if (AccountTransactions.FirstOrDefault(x => x.AccountTransactionTypeId == transactionTypeId) == null)
            {
        ...
        {
            var t = AccountTransactions.FirstOrDefault(x => x.AccountTransactionTypeId == transactionTypeId);
            if (t != null)
            {
