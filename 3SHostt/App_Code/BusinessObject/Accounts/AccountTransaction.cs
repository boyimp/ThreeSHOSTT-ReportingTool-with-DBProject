...
namespace ThreeS.Domain.Models.Accounts
{
    public class AccountTransaction : EntityClass
    {
        ...
        private List<AccountTransactionValue> _accountTransactionValues;
        public virtual List<AccountTransactionValue> AccountTransactionValues
        {
        ...
        {
            get { return AccountTransactionValues.FirstOrDefault(x => x.AccountTypeId == SourceAccountTypeId); }
            set
            {
        ...
        {
            get { return AccountTransactionValues.FirstOrDefault(x => x.AccountTypeId == TargetAccountTypeId); }
            set
            {
