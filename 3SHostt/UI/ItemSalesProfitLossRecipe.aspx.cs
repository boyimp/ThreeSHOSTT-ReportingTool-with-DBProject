...
public partial class UI_ItemSalesProfitLossRecipe : System.Web.UI.Page
{
    ...
    private IList<ItemProfitLossRecipeInfo> GetData(DateTime dtStart, DateTime dtEnd, int departmentid)
    {
        ...
        {           
            ...
            ItemProfitLossRecipeInfo q = new ItemProfitLossRecipeInfo
            {
    ...
    {
        List<Ticket> tickets = TicketManager.GetTickets(0, ddlTicketType.SelectedValue, dtStart, dtEnd);
