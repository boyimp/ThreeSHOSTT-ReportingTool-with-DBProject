...
public partial class UI_MenuItemWiseSalesSummary : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            ...
            if (TicketManager.GetDataFetchFrom() == "FromStoredProcedure")
                ds = TicketManager.GetMenuItemOutletWiseSaleSummarySP(dStartDate, dEndDate, Ids, OutletId);
            ...
            rptViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptMenuItemWiseOutletWiseSalesSummary.rdlc");
