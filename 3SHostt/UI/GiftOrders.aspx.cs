...
public partial class UI_Tickets : System.Web.UI.Page
{
    ...
    public void ConfigureExport()
    {
        ...
        //210 × 297
        RadGrid1.MasterTableView.Caption = "Gift Orders Report" + Environment.NewLine + lblWorkPeriod.Text.ToString();
        ...
        RadGrid1.ExportSettings.FileName = "GiftOrdersReport";
    }
    ...
    protected void RadGrid1_PdfExporting(object sender, GridPdfExportingArgs e)
    {
        ...
        e.RawHTML = ReportManager.GetRawHTML(e, "Gift Orders Report:" + lblWorkPeriod.Text.ToString()).RawHTML;
    }
    ...
    private void BindData()
    {
        ...
        RadGrid1.DataSource = ds.Tables["VoidOrders"];
        RadGrid1.DataBind();
