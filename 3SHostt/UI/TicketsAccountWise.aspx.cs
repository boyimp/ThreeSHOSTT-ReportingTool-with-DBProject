...
public partial class UI_TicketsAccountWise : System.Web.UI.Page
{
    ...
    protected void BindReportViewerDataTicketsWise()
    {
        ...
        DataSet ds = TicketManager.GetTicketsAccountWise(dStartDate.ToString("dd MMM yyyy hh:mm:ss tt"), dEndDate.ToString("dd MMM yyyy hh:mm:ss tt"), 0.001, outletId, Ids);
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            rptViewer1.LocalReport.ReportPath = "./Reports/rptTicketsAccountWise.rdlc";
