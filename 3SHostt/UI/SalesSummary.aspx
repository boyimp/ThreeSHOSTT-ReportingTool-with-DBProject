<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesSummary.aspx.cs" Inherits="UI_SalesSummary" %>
...
<body>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <td>
                <div class="bordered" style="width: 100%">
                    <table width="100%" cellpadding="5" cellspacing="0" border="0" 
                        style="height: 119px" class="filterContainer">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style11">
                                        <asp:RadioButton ID="rbSalesSummary" runat="server" GroupName="View" style="font-weight: 700" 
                                            Text="Sales" />
                                        <asp:RadioButton ID="rbTAXView" runat="server" GroupName="View" style="font-weight: 700" 
                                            Text="TAX" />
                                </td>
        ...
        <tr>
         ...
         <rsweb:ReportViewer ID="rptViewer1" runat="server" Width="1827px" Height="2000px" 
