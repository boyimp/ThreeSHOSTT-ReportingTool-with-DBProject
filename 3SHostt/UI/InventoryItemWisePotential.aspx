...
CodeFile="InventoryItemWisePotential.aspx.cs"
Inherits="UI_InventoryItemWisePotential" %> <%@ Register TagPrefix="uc"
            ...
            <div class="bordered" style="width: 100%">
              ...
              >
                ...
                <tr>
                  ...
                  <td>
                    <asp:Button
                      ID="btn_ShowNewReport"
                      runat="server"
                      Text="Show Special Revenue Report"
                      CssClass="buttonGrey"
                      OnClick="btn_ShowNewReport_Click"
                      Height="68px"
                      Width="366px"
                    ></asp:Button>
                  </td>
