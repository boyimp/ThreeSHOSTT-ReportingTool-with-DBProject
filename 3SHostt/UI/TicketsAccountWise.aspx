<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TicketsAccountWise.aspx.cs" Inherits="UI_TicketsAccountWise" %>
	...
	<uc:header id="header1" runat="server"></uc:header>
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
         ...
         <rsweb:ReportViewer ID="rptViewer1" runat="server" Width="100%" Height="1346px" 
                            ...
                            WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" ShowWaitControlCancelLink="true"  KeepSessionAlive="true" AsyncRendering="true" SizeToReportContent="true">
        </rsweb:ReportViewer>
