...
public partial class UI_WaiterWiseItemSalesReport : System.Web.UI.Page
{
    ...
    protected void RadGrid1_NeedDataSource1(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        RadGrid1.DataSource = WaiterWiseGetData(dStartDate, dEndDate, Convert.ToInt32(ddlTicketType.SelectedValue));//AccountManager.GetCurrentBalanceOfAChead(Convert.ToDateTime(dtpFromDate.SelectedDate), Convert.ToDateTime(dtpToDate.SelectedDate));
    ...
    public void ConfigureExport()
    {
        ...
        //210 × 297
        RadGrid1.MasterTableView.Caption = "Waiter Wise Sales Report" + Environment.NewLine + lblWorkPeriod.Text.ToString();
        ...
        RadGrid1.ExportSettings.FileName = "WaiterWiseSalesReport";
    }

    protected void RadGrid1_PdfExporting(object sender, GridPdfExportingArgs e)
    {

        e.RawHTML = ReportManager.GetRawHTML(e, "Waiter Wise Sales Report:" + lblWorkPeriod.Text.ToString()).RawHTML;
    }
