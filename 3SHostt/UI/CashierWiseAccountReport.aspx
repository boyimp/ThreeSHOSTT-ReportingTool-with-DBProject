<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CashierWiseAccountReport.aspx.cs" Inherits="UI_CashierWiseAccountReport" %>
...
<head id="Head1" runat="server">
    <title>Cashier Wise Account Report</title>
        <!-- CSS only -->
...
<form id="form1" runat="server">
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="filterContainer">
				<tr>
					<td>
