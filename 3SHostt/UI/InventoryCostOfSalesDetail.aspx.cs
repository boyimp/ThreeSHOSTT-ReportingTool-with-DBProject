...
public partial class UI_InventoryCostOfSalesDetail : System.Web.UI.Page
{
    ...
    protected void RadGrid1_NeedDataSource1(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        string dStartDate = dsStartEndDate.Tables[0].Rows[0]["StartDate"].ToString();
        string dEndDate = dsStartEndDate.Tables[0].Rows[0]["EndDate"].ToString();
        ...
        DataSet ds = CurrentStockManager.GetInventoryCostOfSalesDetail(ddlGroupItem.SelectedValue, ddlInventoryItem.SelectedValue, ddlWarehouse.SelectedValue, dStartDate, dEndDate, nFisrtWorkPeriodID, nLastWorkPeriodID);
    ...
    public void ConfigureExport()
    {
        ...
        //210 × 297
        RadGrid1.MasterTableView.Caption = "Inventory Cost of Sales Detail:" + Environment.NewLine + lblWorkPeriod.Text.ToString();
        ...
        RadGrid1.ExportSettings.FileName = "Inventory Cost of Sales Detail";
    }

    protected void RadGrid1_PdfExporting(object sender, GridPdfExportingArgs e)
    {

        e.RawHTML = ReportManager.GetRawHTML(e, "Inventory Cost of Sales Detail:" + lblWorkPeriod.Text.ToString()).RawHTML;
    }
