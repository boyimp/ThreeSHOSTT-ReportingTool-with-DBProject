<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuItemWiseSalesSummary.aspx.cs" Inherits="UI_MenuItemWiseSalesSummary" %>
...
<head runat="server">
	<title>Menu Item Wise Sales Summary</title>
	<link rel="stylesheet" type="text/css" href="../styles.css" />

</head>
<body>
	<form id="form1" runat="server">
	<asp:ScriptManager ID="ScriptManager1" runat="server" AjaxFrameworkMode="Enabled" AsyncPostBackTimeOut="36000">
	</asp:ScriptManager>
	<uc:header ID="header1" runat="server"></uc:header>
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <td>
                    <div class="bordered" style="width: 100%">
                        <table width="100%" cellpadding="5" cellspacing="0" border="0"
                            ...
                            <tr>
                                <td class="auto-style8">Outlets:</td>
                            ...
                            <tr>
                                <td class="auto-style13">Departments :</td>
                                <td class="auto-style4">
                                    <%--<telerik:RadComboBox ID="ddlTicketType" Runat="server" AllowCustomText="true" 
											DataValueField="id" DropDownWidth="200px" EnableLoadOnDemand="true"  CheckBoxes="true" EnableCheckAllItemsCheckBox="true" 
            ...
            <tr>
                <td>
                    <asp:Label ID="lblWorkPeriod" runat="server" Text="" Style="font-size: large; font-weight: 700"></asp:Label></td>
            </tr>

            <tr>
                <td style="padding-left: 1px; width: 100%;">

                    <rsweb:ReportViewer ID="rptViewer1" runat="server" Width="100%" Height="1346px"
