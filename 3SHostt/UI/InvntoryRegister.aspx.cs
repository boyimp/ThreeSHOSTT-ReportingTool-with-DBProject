...
{    
    ...
    private void BindData()
    {
        ...
        DataSet ds = CurrentStockManager.GetInvntoryRegister(ddlGroupItem.SelectedValue, ddlInventoryItem.SelectedValue, ddlWarehouse.SelectedValue, dStartDate, dEndDate, nFisrtWorkPeriodID, nLastWorkPeriodID);
    ...
    public void ConfigureExport()
    {
        ...
        //210 × 297
        RadGrid1.MasterTableView.Caption = "Inventory Register:" + Environment.NewLine + lblWorkPeriod.Text.ToString();
        ...
        RadGrid1.ExportSettings.Pdf.PageWidth = Unit.Parse("1000mm");

        RadGrid1.ExportSettings.ExportOnlyData = true;
        RadGrid1.ExportSettings.IgnorePaging = true;
        RadGrid1.ExportSettings.OpenInNewWindow = true;
        RadGrid1.ExportSettings.FileName = "Inventory Register";
    }

    protected void RadGrid1_PdfExporting(object sender, GridPdfExportingArgs e)
    {

        e.RawHTML = ReportManager.GetRawHTML(e, "Inventory Register:" + lblWorkPeriod.Text.ToString()).RawHTML;
    }
    ...
    protected void RadGrid1_ColumnCreated(object sender, Telerik.Web.UI.GridColumnCreatedEventArgs e)
    {
        ...
        //{
        //    //((Telerik.Web.UI.GridBoundColumn)e.Column).HeaderStyle.HorizontalAlign = HorizontalAlign.Right;

        //    //((Telerik.Web.UI.GridBoundColumn)e.Column) = FilterTemplate.

        //    //((Telerik.Web.UI.GridBoundColumn)e.Column).ItemStyle.HorizontalAlign = HorizontalAlign.Right;
        ...
        //    //((Telerik.Web.UI.GridBoundColumn)e.Column).FooterStyle.HorizontalAlign = HorizontalAlign.Right;
        //}
        //inventoryid, w.Id warehouseid       
        if (e.Column.UniqueName == "InventoryID" || e.Column.UniqueName == "WarehouseID" || e.Column.UniqueName == "StartDate" || e.Column.UniqueName == "EndDate")
        {
