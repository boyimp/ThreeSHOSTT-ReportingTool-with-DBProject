...
public partial class UI_TicketsAccountWise : System.Web.UI.Page
{
    ...
    protected void BindReportViewerDataTicketsWise()
    {
        ...
        DataSet ds = TicketManager.GetTicketsAccountWise(dStartDate.ToString("dd MMM yyyy hh:mm:ss tt"), dEndDate.ToString("dd MMM yyyy hh:mm:ss tt"), VATIncludedDenominator, outletId, Ids);
    ...
    protected void BindReportViewerDataDayWise()
    {
        ...
        DataSet ds = TicketManager.GetTicketsAccountDayWise(dStartDate.ToString("dd MMM yyyy hh:mm:ss tt"), dEndDate.ToString("dd MMM yyyy hh:mm:ss tt"), VATIncludedDenominator, outletId, Ids);
