<%@ Page Language="C#"  Title="Inventory Cost Of Sales Total" MasterPageFile="~/Views/ReportingTool.master"  AutoEventWireup="true" CodeFile="InventoryCostOfSalesTotal.aspx.cs" Inherits="UI_InventoryCostOfSalesTotal" %>
						...
						<div class="bordered" style="width:100%">
							<table width="100%" cellpadding="3" cellspacing="0" border="0">
                            	<tr>
									...
									<td class="auto-style4"><telerik:RadDatePicker ID="dtpFromDate" runat="server"></telerik:RadDatePicker></td>
									<td align="right" class="auto-style6">To Date:</td>
									<td class="auto-style3"><telerik:RadDatePicker ID="dtpToDate" runat="server"></telerik:RadDatePicker></td>
									<td class="auto-style3"> </td>
								</tr>
								<tr>
									<td align="right" class="auto-style8">Inventory Group Item:</td>
									<td class="auto-style9"><rad:RadComboBox Skin="WebBlue" id="ddlGroupItem" Runat="server" Height="170px" Width="200px" DataValueField="GroupCode"
									...
									<td align="right" class="auto-style10">Inventory Item:</td>
								...
								<tr>
									...
									<td ><asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary btn-lg"
                                            OnClick="btnSearch_Click" Height="80px" Width="229px"></asp:Button>
                                    </td>
									<td></td>
