<%@ Page Language="C#"  Title="Inventory Register" MasterPageFile="~/Views/ReportingTool.master" AutoEventWireup="true" CodeFile="InvntoryRegister.aspx.cs"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="auto-style16">
        <tr>
            <td>
                <div class="bordered" style="width: 100%">
                    <table width="100%" cellpadding="3" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td align="right" class="auto-style10">To Date:
                            </td>
                        ...
                        <tr>
                            <td align="right" class="auto-style4">Inventory Group Item:
                            </td>
                            ...
                            <td align="right" class="auto-style11">Inventory Item:
                            </td>
                        ...
                        <tr>
                            <td align="right" class="auto-style5">Warehouse:
                            </td>
                            ...
                            <td class="auto-style15">
                                <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary btn-lg" OnClick="btnSearch_Click"
                                    Height="65px" Width="232px"></asp:Button>
                            </td>
        ...
        <tr>
            <td>
                ...
                <asp:Label ID="lblWorkPeriod" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="padding-left: 1px; width: 100%;">
                <telerik:RadGrid ID="RadGrid1" AllowSorting="true" FilterItemStyle-Width="150px"
                    AllowFilteringByColumn="true" ShowFooter="True" AutoGenerateColumns="false" runat="server"
                    OnNeedDataSource="RadGrid1_NeedDataSource1" OnItemCommand="RadGrid1_ItemCommand"
                    OnColumnCreated="RadGrid1_ColumnCreated" OnPdfExporting="RadGrid1_PdfExporting">
