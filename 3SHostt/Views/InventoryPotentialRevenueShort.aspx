<%@ Page Language="C#" Title="Inventory Potential Revenue" MasterPageFile="~/Views/ReportingTool.master" AutoEventWireup="true" CodeFile="InventoryPotentialRevenueShort.aspx.cs" Inherits="UI_InventoryPotentialRevenueShort" %>
